...
export const CompanyOnboardingModal: React.FC<CompanyOnboardingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/75 backdrop-blur-md overflow-y-auto">
      <div className="relative max-w-xl w-full my-6 glass-panel p-6 sm:p-8 rounded-3xl shadow-2xl border-2 border-orange-500/30 bg-white/95 text-slate-900 animate-in fade-in zoom-in-95 duration-200">
        {/* Close Button */}
        <button
          onClick={onClose}
          type="button"
        ...
        {submitted ? (
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Register your organization to create a dedicated company admin login
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              {/* ── Section 4: Remarks / Special Needs ── */}
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1">
              ...
              <button
                type="submit"
                disabled={loading}
                className="btn-tactile w-full py-3.5 bg-gradient-to-r from-orange-500 via-orange-600 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-black rounded-2xl text-xs sm:text-sm shadow-md flex items-center justify-center gap-2 transition-all disabled:opacity-50 cursor-pointer mt-2"
              >
                {loading ? (
